namespace Employee_Managment
{
    partial class EmployeeForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            topPanel.Controls.Add(lblUserRole);
            ...
            lblUserRole.BackColor = Color.FromArgb(52, 73, 94);
            lblUserRole.Font = new Font("Segoe UI", 10F, FontStyle.Bold);
            lblUserRole.ForeColor = Color.FromArgb(241, 196, 15);
            lblUserRole.Location = new Point(903, 12);
            lblUserRole.Name = "lblUserRole";
            lblUserRole.Padding = new Padding(14, 7, 14, 7);
            lblUserRole.Size = new Size(121, 37);
